...
export default function Profile() {
  return (
    <div className=" h-screen flex justify-center items-center  space-x-14">
        <div className="max-w-sm h-auto bg-white rounded-xl shadow-2x1">
            <img src="images/bg11.jpg" alt="image" className="w-full rounded-t-xl "/>
        ...
        <div className="max-w-sm h-auto bg-white rounded-xl shadow-2x1">
            <img src="images/bg12.jpg" alt="image" className="w-full rounded-t-xl "/>
            <h2 className="font-bold text-lg my-2 mx-4 hover:cursor-default">Abdul</h2>
            <p className="font-medium text-sm my-4 mx-4 hover:cursor-default">
            Lorem Ipsum is simply dummy text of the printing and typesetting industry. 
            Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, 
